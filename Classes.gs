...
var CLASS_CATALOGUE = [
  ...
  { id: 'shield-knight', name: 'Shield Knight', displayName: 'Shield Knight', iconAsset: 'stormblade.png', colour: 'blue', colourFamily: 'blue', role: 'tank', roleLabel: 'Tank', roleColor: 'blue', combatRole: 'tank',
    builds: [{ id: 'main', name: 'Main' }, { id: 'shield', name: 'Shield' }, { id: 'recovery', name: 'Recovery' }] },
  { id: 'stormblade', name: 'Stormblade', displayName: 'Stormblade', iconAsset: 'shield-knight.png', colour: 'red', colourFamily: 'red', role: 'dps', roleLabel: 'DPS', roleColor: 'red', combatRole: 'dps',
